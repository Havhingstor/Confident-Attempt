...
func getPreviewContainer() -> ModelContainer {
    ...
    let habit1 = Habit.new(name: "Test 1", textDescription: "Test")
    let habit2 = Habit.new(name: "Test 2", textDescription: "Test", repetition: .none)
    let habit3 = Habit.new(name: "Test 3", textDescription: "Test", repetition: 10)
    let habit4 = Habit.new(name: "Test 4", textDescription: "Test", goal: .weekly(number: 3))
