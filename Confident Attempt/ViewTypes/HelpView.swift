    ...
    var body: some View {
        List {
            ...
            Section("Tips") {
                ...
                Text("The remaining text is red if the number of completions is below the minimum for the given period (both of which can be configured in the settings), and green if the number of completions is above the goal. Otherwise, it is black.")
            }
        }
